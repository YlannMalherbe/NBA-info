...
class TeamData:
    ...
    def __init__(self, team_tricode: str) -> None:
        ...
        self._team_schedule = Schedule(
            gamesData=TeamData._schedule.get_matchs_x_team(team_tricode)
        )
    ...
    def get_win_lose(self):
        ...
        team_result = (
            last_match.homeTeam
            if last_match.homeTeam["teamTricode"] == self.tricode
            else last_match.awayTeam
        )
